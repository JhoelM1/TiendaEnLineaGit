...
$sql = "INSERT INTO admin (usuario, password, nombre, correo, activo, fecha_alta)
VALUES ('admin', '$password', 'Administrador','jhoel@gmail.com', '1', NOW())";
$con->query($sql);*/
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Iniciar sesión - Administrador</h3></div>
                                    <div class="card-body">
