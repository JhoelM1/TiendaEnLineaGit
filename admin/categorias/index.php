            ...
            <table class="table table-hover">
                ...
                <?php foreach ($categorias as $categoria) { ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modaElimina" data-bs-id="<?php echo $categoria['id']; ?>" >Eliminar </button>
...
>
    ...
    >
        <div class="modal-content">
            ...
            <div class="modal-body">Desea eliminar la categoría?</div>
