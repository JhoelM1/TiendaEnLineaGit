...
<main>
    <div class="container">
        ...
        <form class="row g-3" action="cambiar_password.php" method="post" autocomplete="off">
            ...
            <div class="form-floating">
                <input type="password" class="form-control" id="password" name="password" placeholder="Ingrese su nueva contraseña" required autofocus>
                <label for="password">Nueva contraseña:</label>
            </div>

            <div class="form-floating">
                <input type="password" class="form-control" id="repassword" name="repassword" placeholder="Confirme su nueva contraseña" required autofocus>
